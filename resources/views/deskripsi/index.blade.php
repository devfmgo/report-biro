...
<x-app-layout>
    <x-slot name="header">
        ...
        <a href="/deskripsi/create" class=" text-xs float-right bg-purple-400 rounded-full px-8 text-white font-extrabold p-3 relative bottom-7">
            Create Deskripsi</a>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6 bg-white border-b border-gray-200 shadow-md rounded my-6">
