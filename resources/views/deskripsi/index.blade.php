                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            ...
                            @foreach ($deskripsi as $data)
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-6 text-left text-gray-700 capitalize">
                                        {{ $data->deskripsi }}
                                    </td>
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex item-center justify-center">
                                            ...
                                            <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                <button class="w-4 text-red-600" type="button"
                                                    onclick="toggleModal('modal-id{{ $data->id }}')">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                        viewBox="0 0 24 24" stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"
                                            ...
                                            <div
                                                ...
                                                <div class="relative p-6 flex-auto text-center  justify-center">
                                                    ...
                                                    <h2 class="text-xl font-bold py-4 ">Are you sure?</h3>
                                                        <p class="text-sm text-gray-500 px-8">Yakin data akan dihapus
                                                        </p>
                                                </div>
                                                <div class="p-3  mt-2 text-center space-x-4 md:block">
                                                    <div class="flex justify-center space-x-1">
                                                        ...
                                                        <div>
                                                            <form action="/deskripsi/{{ $data->id }}" method="post">
                                                                @csrf
                                                                @method('delete')
