                ...
                <div class="flex w-1/2 justify-end content-center">
                    @if (Route::has('login'))
                        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                            ...
                            @else
                                <a href="{{ route('login') }}"
                                    class="text-sm text-gray-100 bg-blue-400 p-2 px-4 rounded-full font-medium">Sign in</a>
        ...
        <div class="container pt-24 md:pt-48 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
                <h1
                    ...
                    Department Weekly Report </h1>
                <p class="leading-normal text-base md:text-2xl mb-8 text-center md:text-left slide-in-bottom-subtitle">
                    Sub-hero message, not too long and not too short. Make it just right!</p>
                <a href="{{ route('login') }}"
                    class="leading-normal text-base md:text-2xl mb-8 text-center md:text-left slide-in-bottom-subtitle bg-blue-400  capitalize p-2 rounded-full px-10 text-white hover:bg-blue-500">Sign
                    In</a>
            </div>
            ...
            <!--Footer-->
            <div class="w-full pt-16 pb-6 text-sm md:text-left fade-in text-center">
                <a class="text-gray-500 no-underline hover:no-underline" href="#">&copy; TIK 2021 V.1</a>
            </div>
